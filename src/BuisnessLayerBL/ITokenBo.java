...
public interface ITokenBo {
    boolean addTokensForSentence(String chapterName, int sentenceNumber, List<TokenData> tokens);
    boolean updateTokensForSentence(String chapterName, int sentenceNumber, List<TokenData> tokens);
    List<TokenData> retrieveTokensForSentence(String chapterName, int sentenceNumber);
    ...
    public java.util.List<java.util.Map<String, String>> getSentencesByToken(String tokenText);
